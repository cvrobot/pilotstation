...
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.ACTION_ACCEPT_MAGNETOMETER_CALIBRATION;
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.ACTION_CANCEL_MAGNETOMETER_CALIBRATION;
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.ACTION_SEND_IMU_CALIBRATION_ACK;
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.ACTION_START_IMU_CALIBRATION;
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.ACTION_START_MAGNETOMETER_CALIBRATION;
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.EXTRA_IMU_STEP;
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.EXTRA_RETRY_ON_FAILURE;
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.EXTRA_SAVE_AUTOMATICALLY;
import static com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions.EXTRA_START_DELAY;
