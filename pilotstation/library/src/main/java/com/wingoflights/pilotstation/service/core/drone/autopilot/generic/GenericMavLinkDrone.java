package com.wingoflights.pilotstation.service.core.drone.autopilot.generic;
...
import com.wingoflights.pilotstation.api.lib.util.MathUtils;
...
import com.wingoflights.pilotstation.service.core.MAVLink.MavLinkWaypoint;
import com.wingoflights.pilotstation.service.core.MAVLink.WaypointManager;
import com.wingoflights.pilotstation.service.core.drone.DroneEvents;
...
import com.wingoflights.pilotstation.service.core.drone.variables.Type;
...
import com.wingoflights.pilotstation.service.utils.video.VideoManager;
    ...
    public DroneAttribute getAttribute(String attributeType) {
        ...
        switch (attributeType) {
            ...
            case AttributeType.STATE:
                Log.d("generic","call  CommonApiUtils.getState(this, isConnected(), vibration):" + isConnected());
