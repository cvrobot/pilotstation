package com.wingoflights.pilotstation.api.lib.drone.attribute;
...
public class AttributeType {
    ...
    private static final String PACKAGE_NAME = "com.wingoflights.pilotstation.api.lib.attribute";
     ...
     * @see {@link com.wingoflights.pilotstation.api.lib.drone.property.Altitude}
     */
    public static final String ALTITUDE = PACKAGE_NAME + ".ALTITUDE";

    /**
     * Used to access the vehicle's attitude state.
     * @see {@link com.wingoflights.pilotstation.api.lib.drone.property.Attitude}
     */
    public static final String ATTITUDE = PACKAGE_NAME + ".ATTITUDE";

    /**
     * Used to access the vehicle's battery state.
     * @see {@link com.wingoflights.pilotstation.api.lib.drone.property.Speed}
     */
     ...
     * @see {@link com.wingoflights.pilotstation.api.lib.drone.property.State} object.
     */
    public static final String STATE = PACKAGE_NAME + ".STATE";

    /**
     * Used to access the vehicle type.
     * @see {@link com.wingoflights.pilotstation.api.lib.drone.property.Type}
     */
     ...
     * @see {@link com.wingoflights.pilotstation.api.lib.drone.calibration.magnetometer.MagnetometerCalibrationStatus}
     */
     ...
     * @see {@link com.wingoflights.pilotstation.api.lib.gcs.returnToMe.ReturnToMeState}
     */
