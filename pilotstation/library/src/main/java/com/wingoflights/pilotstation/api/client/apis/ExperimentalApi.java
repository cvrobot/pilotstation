...
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.ACTION_SEND_MAVLINK_MESSAGE;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.ACTION_SET_RELAY;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.ACTION_SET_ROI;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.ACTION_SET_SERVO;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.ACTION_TRIGGER_CAMERA;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.EXTRA_IS_RELAY_ON;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.EXTRA_MAVLINK_MESSAGE;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.EXTRA_RELAY_NUMBER;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.EXTRA_SERVO_CHANNEL;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.EXTRA_SERVO_PWM;
import static com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions.EXTRA_SET_ROI_LAT_LONG_ALT;
