...
import static com.wingoflights.pilotstation.api.lib.drone.action.GimbalActions.*;
...
public final class GimbalApi extends Api implements DroneListener {
    ...
    public interface GimbalOrientationListener {
         ...
         * @param error @see {@link com.wingoflights.pilotstation.api.lib.drone.attribute.error.CommandExecutionError}
         */
