...
//import com.wingoflights.pilotstation.service.DroidPlannerServicesApp;
...
import com.wingoflights.pilotstation.service.communication.connection.AndroidTcpConnection;
import com.wingoflights.pilotstation.service.communication.connection.AndroidUdpConnection;
import com.wingoflights.pilotstation.service.communication.connection.BluetoothConnection;
import com.wingoflights.pilotstation.service.communication.connection.usb.UsbConnection;
...
//import com.wingoflights.pilotstation.service.ui.activity.MainActivity;
import com.wingoflights.pilotstation.service.utils.Utils;
//import com.wingoflights.pilotstation.service.utils.analytics.GAUtils;
import com.wingoflights.pilotstation.service.utils.file.IO.CameraInfoLoader;
import com.wingoflights.pilotstation.service.utils.LogToFileTree;
 ...
 */
public class PilotStationService extends Service {

    private static final String TAG = PilotStationService.class.getName();
    ...
    public IBinder onBind(Intent intent) {
        ...
        final String action = intent.getAction();
        if (IPilotStationServices.class.getName().equals(action)) {
    ...
    public void onCreate() {
        ...
        ptServices = new PTServices(this);
