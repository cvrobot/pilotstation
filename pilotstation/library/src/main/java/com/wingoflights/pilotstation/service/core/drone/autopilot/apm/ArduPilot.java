...
import com.wingoflights.pilotstation.api.lib.drone.action.ExperimentalActions;
import com.wingoflights.pilotstation.api.lib.drone.action.GimbalActions;
import com.wingoflights.pilotstation.api.lib.drone.action.ParameterActions;
...
import com.wingoflights.pilotstation.api.lib.gcs.action.CalibrationActions;
...
import com.wingoflights.pilotstation.service.core.MAVLink.MavLinkParameters;
...
import com.wingoflights.pilotstation.service.core.drone.autopilot.apm.variables.APMHeartBeat;
...
import com.wingoflights.pilotstation.service.core.drone.variables.HeartBeat;
import com.wingoflights.pilotstation.service.core.drone.variables.Magnetometer;
import com.wingoflights.pilotstation.service.core.drone.variables.RC;
...
public abstract class ArduPilot extends GenericMavLinkDrone {
    ...
    private final com.wingoflights.pilotstation.service.core.drone.variables.RC rc;
    ...
    public boolean executeAsyncAction(Action action, final ICommandListener listener) {
        ...
        switch (type) {
            ...
            case MissionActions.ACTION_SET_MISSION:
                data.setClassLoader(com.wingoflights.pilotstation.api.lib.drone.mission.Mission.class.getClassLoader());
                com.wingoflights.pilotstation.api.lib.drone.mission.Mission mission = data.getParcelable(MissionActions.EXTRA_MISSION);
            ...
            case ParameterActions.ACTION_WRITE_PARAMETERS:
                data.setClassLoader(com.wingoflights.pilotstation.api.lib.drone.property.Parameters.class.getClassLoader());
                com.wingoflights.pilotstation.api.lib.drone.property.Parameters parameters = data.getParcelable(ParameterActions.EXTRA_PARAMETERS);
