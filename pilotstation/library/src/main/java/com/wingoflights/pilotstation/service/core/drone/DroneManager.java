...
import com.wingoflights.pilotstation.api.lib.drone.action.CapabilityActions;
import com.wingoflights.pilotstation.api.lib.drone.action.ControlActions;
import com.wingoflights.pilotstation.api.lib.drone.action.GimbalActions;
import com.wingoflights.pilotstation.api.lib.drone.action.StateActions;
import com.wingoflights.pilotstation.api.lib.drone.attribute.AttributeEvent;
import com.wingoflights.pilotstation.api.lib.drone.attribute.AttributeEventExtra;
...
import com.wingoflights.pilotstation.api.lib.drone.connection.DroneSharePrefs;
import com.wingoflights.pilotstation.api.lib.drone.mission.action.MissionActions;
...
import com.wingoflights.pilotstation.api.lib.gcs.action.FollowMeActions;
import com.wingoflights.pilotstation.api.lib.gcs.follow.FollowType;
import com.wingoflights.pilotstation.api.lib.gcs.returnToMe.ReturnToMeState;
...
import com.wingoflights.pilotstation.service.api.DroneApi;
import com.wingoflights.pilotstation.service.api.MavLinkServiceApi;
import com.wingoflights.pilotstation.service.communication.connection.DroneshareClient;
import com.wingoflights.pilotstation.service.communication.service.MAVLinkClient;
import com.wingoflights.pilotstation.service.communication.service.UploaderService;
import com.wingoflights.pilotstation.service.core.MAVLink.MAVLinkStreams;
import com.wingoflights.pilotstation.service.core.MAVLink.MavLinkMsgHandler;
import com.wingoflights.pilotstation.service.core.drone.autopilot.Drone;
import com.wingoflights.pilotstation.service.core.drone.autopilot.MavLinkDrone;
import com.wingoflights.pilotstation.service.core.drone.autopilot.apm.ArduCopter;
import com.wingoflights.pilotstation.service.core.drone.autopilot.apm.ArduPlane;
import com.wingoflights.pilotstation.service.core.drone.autopilot.apm.ArduRover;
import com.wingoflights.pilotstation.service.core.drone.autopilot.apm.solo.ArduSolo;
import com.wingoflights.pilotstation.service.core.drone.autopilot.generic.GenericMavLinkDrone;
import com.wingoflights.pilotstation.service.core.drone.autopilot.px4.Px4Native;
import com.wingoflights.pilotstation.service.core.drone.autopilot.apm.solo.SoloComp;
...
import com.wingoflights.pilotstation.service.core.gcs.GCSHeartbeat;
import com.wingoflights.pilotstation.service.core.gcs.ReturnToMe;
import com.wingoflights.pilotstation.service.core.gcs.follow.Follow;
import com.wingoflights.pilotstation.service.core.gcs.follow.FollowAlgorithm;
import com.wingoflights.pilotstation.service.core.gcs.location.FusedLocation;
import com.wingoflights.pilotstation.service.exception.ConnectionException;
import com.wingoflights.pilotstation.service.utils.AndroidApWarningParser;
import com.wingoflights.pilotstation.service.utils.CommonApiUtils;
//import com.wingoflights.pilotstation.service.utils.analytics.GAUtils;
import com.wingoflights.pilotstation.service.utils.prefs.DroidPlannerPrefs;
...
public class DroneManager implements MAVLinkStreams.MavlinkInputStream, DroneInterfaces.OnDroneListener,
    ...
    public boolean executeAsyncAction(DroneApi.ClientInfo clientInfo, Action action, ICommandListener listener) {
        ...
        switch (type) {
            ...
            default:
                if (drone != null) {
                    Log.i("dronemgr", "drone.executeAsyncAction" + action.getType());
                    return drone.executeAsyncAction(action, listener);
                } else {
                    Log.i("dronemgr", "CommonApiUtils.executeAsyncAction" + action.getType());
                    CommonApiUtils.postErrorEvent(CommandExecutionError.COMMAND_FAILED, listener);
                    return true;
                }
        }
