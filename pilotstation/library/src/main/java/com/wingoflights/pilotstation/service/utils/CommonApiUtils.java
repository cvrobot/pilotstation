...
import com.wingoflights.pilotstation.api.lib.drone.calibration.magnetometer.MagnetometerCalibrationProgress;
import com.wingoflights.pilotstation.api.lib.drone.calibration.magnetometer.MagnetometerCalibrationResult;
import com.wingoflights.pilotstation.api.lib.drone.calibration.magnetometer.MagnetometerCalibrationStatus;
import com.wingoflights.pilotstation.api.lib.drone.mission.Mission;
...
import com.wingoflights.pilotstation.api.lib.drone.property.CameraProxy;
import com.wingoflights.pilotstation.api.lib.drone.property.EkfStatus;
import com.wingoflights.pilotstation.api.lib.drone.property.FootPrint;
import com.wingoflights.pilotstation.api.lib.drone.property.Gps;
import com.wingoflights.pilotstation.api.lib.drone.property.GuidedState;
import com.wingoflights.pilotstation.api.lib.drone.property.Parameter;
import com.wingoflights.pilotstation.api.lib.drone.property.Parameters;
...
import com.wingoflights.pilotstation.api.lib.drone.property.Vibration;
import com.wingoflights.pilotstation.api.lib.gcs.follow.FollowState;
...
import com.wingoflights.pilotstation.service.core.drone.autopilot.apm.ArduPilot;
...
import com.wingoflights.pilotstation.service.core.survey.Footprint;
...
public class CommonApiUtils {
    ...
    public static State getState(MavLinkDrone drone, boolean isConnected, Vibration vibration) {
        ...
        com.wingoflights.pilotstation.service.core.drone.variables.State droneState = drone.getState();
    ...
    public static Mission getMission(MavLinkDrone drone) {
        ...
        com.wingoflights.pilotstation.service.core.mission.Mission droneMission = drone.getMission();
    ...
    public static void arm(final ArduPilot drone, final boolean arm, final boolean emergencyDisarm, final ICommandListener listener) {
        ...
        if (!arm && emergencyDisarm) {
            if (com.wingoflights.pilotstation.service.core.drone.variables.Type.isCopter(drone.getType()) && !isKillSwitchSupported(drone)) {
    ...
    public static boolean isKillSwitchSupported(MavLinkDrone drone) {
        ...
        if (!com.wingoflights.pilotstation.service.core.drone.variables.Type.isCopter(drone.getType()))
            return false;
    ...
    public static Survey buildSurvey(MavLinkDrone drone, Survey survey) {
        com.wingoflights.pilotstation.service.core.mission.Mission droneMission = drone == null ? null : drone.getMission();
