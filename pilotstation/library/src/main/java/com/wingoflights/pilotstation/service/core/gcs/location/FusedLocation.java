package com.wingoflights.pilotstation.service.core.gcs.location;
...
import com.wingoflights.pilotstation.api.lib.util.googleApi.GoogleApiClientManager;
import com.wingoflights.pilotstation.api.lib.util.googleApi.GoogleApiClientManager.GoogleApiClientTask;

import com.wingoflights.pilotstation.service.core.gcs.location.Location.LocationFinder;
...
public class FusedLocation extends LocationCallback implements LocationFinder, GoogleApiClientManager.ManagerListener {
    ...
    public void onLocationResult(LocationResult result) {
        ...
        com.wingoflights.pilotstation.service.core.gcs.location.Location location =
                new com.wingoflights.pilotstation.service.core.gcs.location.Location(
                new LatLongAlt(
    ...
    private void notifyLocationUpdate(com.wingoflights.pilotstation.service.core.gcs.location.Location location) {
