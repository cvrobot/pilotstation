...
import com.wingoflights.pilotstation.api.lib.drone.companion.solo.controller.SoloControllerMode;
import com.wingoflights.pilotstation.api.lib.drone.companion.solo.controller.SoloControllerUnits;
import com.wingoflights.pilotstation.api.lib.drone.companion.solo.tlv.SoloButtonSettingSetter;
...
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.ACTION_REFRESH_SOLO_VERSIONS;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_BUTTON_SETTINGS;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_CONTROLLER_MODE;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_EU_TX_POWER_COMPLIANCE;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_WIFI_SETTINGS;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_BUTTON_SETTINGS;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_CONTROLLER_MODE;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_EU_TX_POWER_COMPLIANT;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_WIFI_PASSWORD;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_WIFI_SSID;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.ACTION_UPDATE_CONTROLLER_UNIT;
import static com.wingoflights.pilotstation.api.lib.drone.companion.solo.action.SoloConfigActions.EXTRA_CONTROLLER_UNIT;
...
public class SoloConfigApi extends SoloApi {
     ...
     *
     * @param controllerMode Controller mode. @see {@link com.wingoflights.pilotstation.api.lib.drone.companion.solo.controller.SoloControllerMode.ControllerMode}
     * @param listener       Register a callback to receive update of the command execution status.
     */
     ...
     * @param controllerUnit Controller unit system. @see {@link com.wingoflights.pilotstation.api.lib.drone.companion.solo.controller.SoloControllerUnits.ControllerUnit}
