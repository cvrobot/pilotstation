...
public class SoloEvents {
    ...
    private static final String PACKAGE_NAME = "com.wingoflights.pilotstation.api.lib.drone.companion.solo.event";

    /**
     * Broadcasts updates to the GoPro state.
     *
     * @see {@link com.wingoflights.pilotstation.api.lib.drone.companion.solo.tlv.SoloGoproState}
     */
     ...
     * @see {@link com.wingoflights.pilotstation.api.lib.drone.companion.solo.tlv.SoloGoproStateV2}
     */
