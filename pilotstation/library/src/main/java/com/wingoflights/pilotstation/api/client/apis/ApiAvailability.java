...
//import com.wingoflights.pilotstation.api.client.utils.InstallServiceDialog;
...
public class ApiAvailability {
    ...
    private static final String SERVICES_CLAZZ_NAME = IPilotStationServices.class.getName();
    ...
    public int checkApiAvailability(@NonNull final Context context) {
        ...
        final ResolveInfo serviceInfo = pm.resolveService(serviceIntent, 0 );//PackageManager.GET_META_DATA
        if (serviceInfo == null) {
            return API_MISSING;
        }
