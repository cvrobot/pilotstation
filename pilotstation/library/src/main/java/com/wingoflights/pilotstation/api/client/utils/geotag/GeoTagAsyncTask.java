package com.wingoflights.pilotstation.api.client.utils.geotag;

import android.media.ExifInterface;
import android.os.AsyncTask;

import com.MAVLink.ardupilotmega.msg_camera_feedback;
import com.wingoflights.pilotstation.api.client.utils.data.tlog.TLogParser;
...
public abstract class GeoTagAsyncTask extends AsyncTask<Void, Integer, GeoTagAsyncTask.ResultObject> {
     ...
     * @param events   {@link List<com.wingoflights.pilotstation.api.client.utils.data.tlog.TLogParser.Event>} list of events to geotag photos.
